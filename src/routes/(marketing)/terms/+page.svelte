...
<div class="legal-page">
  <div class="container">
    ...
    <div class="legal-body">
      ...
      <section>
        <h2>2. Eligibility</h2>
        <p>You must be at least 18 years of age to use the Platform. By registering, you confirm that you are 18 or older and legally capable of entering into a binding contract under the laws of your jurisdiction.</p>
        <p>Access to investment features is restricted to <strong>qualified/accredited investors</strong> as defined under applicable law. Registering as an investor on the Platform does not, by itself, constitute an offer of investment or financial advice.</p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>A guarantee of returns, yields, or capital preservation</li>
        </ul>
        <p>Before investing, you should seek independent financial and legal advice appropriate to your circumstances.</p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>Complete any enhanced due diligence we may request</li>
        </ul>
        <p>We may decline or terminate any investment relationship where we cannot complete satisfactory due diligence.</p>
      </section>
      ...
      <section>
        ...
        <p>We may update these Terms from time to time. Material changes will be notified to registered users at least 14 days before they take effect. Continued use of the Platform after the effective date constitutes acceptance of the revised Terms.</p>
      </section>
